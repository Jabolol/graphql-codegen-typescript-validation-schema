...
describe('zod', () => {
  ...
  describe('with oneOf directive', () => {
    it('primitive defined', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function PrimitiveInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              a: z.string(),
              b: z.undefined(),
    ...
    it('ref input object', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function AInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              b: z.lazy(() => BInputSchema()),
              c: z.undefined()
        ...
        export function BInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              c: z.lazy(() => CInputSchema()),
              d: z.undefined()
        ...
        export function CInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              d: z.lazy(() => DInputSchema()),
              e: z.undefined()
        ...
        export function DInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              e: z.lazy(() => EInputSchema()),
              a: z.undefined()
        ...
        export function EInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              a: z.lazy(() => AInputSchema()),
              b: z.undefined()
    ...
    it('nested input object', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function NestedInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
    ...
    it('enum', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        ...
        export function PageInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              pageType: PageTypeSchema,
    ...
    it('with scalars', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function SaySchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              phrase: z.string(),
              times: z.undefined(),
    ...
    it('with notAllowEmptyString and nested input', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function InputOneSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
    ...
    it('with scalarSchemas', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function ScalarsInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              date: z.date(),
              email: z.undefined(),
    ...
    it('properly generates custom directive values', async () => {
      ...
      expect(removedInitialEmitValue(result.content)).toMatchInlineSnapshot(`
        "
        export function UserCreateInputSchema(): z.ZodUnion<z.ZodUnionOptions> {
          return z.union([
            z.object({
              name: z.string().regex(/^Sir/),
              age: z.undefined()
